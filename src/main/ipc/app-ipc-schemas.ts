...
import {
  ...
  KUN_SKILLS_TEMPLATE,
  KUN_TASKS_TEMPLATE,
  KUN_TASK_RESUME_TEMPLATE,
  KUN_TASK_STEPS_TEMPLATE,
  KUN_TASK_TEMPLATE,
  KUN_TASK_TRANSITION_TEMPLATE,
...
const ENDPOINTS: readonly EndpointTemplate[] = [
  ...
  compileEndpoint(KUN_TASKS_TEMPLATE, ['GET', 'POST']),
  compileEndpoint(KUN_TASK_TEMPLATE, ['GET']),
  compileEndpoint(KUN_TASK_TRANSITION_TEMPLATE, ['POST']),
  compileEndpoint(KUN_TASK_STEPS_TEMPLATE, ['PATCH']),
  compileEndpoint(KUN_TASK_RESUME_TEMPLATE, ['POST']),
...
export const claude360MusicMediaProbePayloadSchema = z
  .object({
    url: trimmedString(4096)
  })
  .strict()
