...
const api = {
  ...
  claude360BillingLogs: (payload) => ipcRenderer.invoke('claude360:billing:logs', payload),
  claude360BillingLogsStat: (payload) => ipcRenderer.invoke('claude360:billing:logs-stat', payload),
  ...
  readLocalOfficeText: (options) =>
    ipcRenderer.invoke('file:read-local-office-text', options),
