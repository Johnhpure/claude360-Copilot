    ...
    <div className="flex min-h-[72px] w-full items-center gap-3 rounded-[18px] border border-ds-border-muted bg-ds-card px-4 py-3 shadow-[var(--c360-shadow-sm)]">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div
          ...
          title={url}
        >
          <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-ds-success shadow-[0_0_0_3px_var(--ds-success-soft)]" />
      ...
      {opened ? (
        ...
        <button
          type="button"
          onClick={onOpen}
          className="inline-flex h-9 shrink-0 items-center justify-center rounded-full bg-accent px-4 text-[13px] font-semibold text-white shadow-[var(--c360-shadow-sm)] transition hover:bg-accent-hover"
