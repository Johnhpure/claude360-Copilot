  ...
  return (
    ...
    >
      <div className="shrink-0 border-b border-ds-border-muted bg-ds-card">
        <div className="flex h-10 min-w-0 items-center gap-2 border-b border-ds-border-muted bg-ds-subtle px-3">
          <div className="flex h-8 min-w-0 max-w-[15rem] items-center gap-2 rounded-[8px] bg-ds-card px-2.5 pl-3 text-[12px] font-semibold text-ds-ink shadow-[var(--c360-shadow-sm)]">
